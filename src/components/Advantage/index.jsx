  ...
  return (
    <section className="advantage-section">
      <div className="container">
        <h2 className="advantage-section__question">Why Fiber?</h2>
        <p className="advantage-section__reason">
          A good portfolio means good employability.
        </p>
        <ul className="advantage-section__list" aria-label="Advantages">
          <li className="advantage-section__list-item">
            <svg
              className="icon"
              aria-hidden="true"
              width="40"
            ...
            <h3 className="title">Build in minutes</h3>
            <p className="content">
          ...
          <li className="advantage-section__list-item">
            ...
            <h3 className="title">
              Add custom <abbr title="Cascading style sheets">CSS</abbr>
            </h3>
            <p className="content">
              Customize your personal portfolio even more with the ability to
              add your custom <abbr title="Cascading style sheets">CSS</abbr>{" "}
              styles.
            </p>
          </li>
          <li className="advantage-section__list-item">
